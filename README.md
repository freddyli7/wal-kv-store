...
- tests with multiple async tasks, single and multi-threaded executor
- thoughts on the interface (e.g. trait_variant, non-mut get and delete, return value on set, etc.)
